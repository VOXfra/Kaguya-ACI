'use strict';
/* V1.1.4 : attend les hotfixes 1.0.9, charge les couches 1.1 historiques puis
   applique dans l'ordre le catalogue canonique, la boutique Créative et enfin
   le correctif qui expose les 200 collections et verrouille la pile d'ouverture. */
(function v111Boot(){
 let tries=0;
 ...
 const load=()=>{
  ...
  add('v111fix.js',()=>add('v111catalogfix.js',()=>add('v111condition.js',()=>add('v111conditionfix.js',()=>add('v111perf.js',()=>add('v112fix.js',()=>add('v113fix.js',()=>add('v114fix.js'))))))));
 };

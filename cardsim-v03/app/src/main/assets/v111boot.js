'use strict';
/* V1.1.2 : attend les hotfixes 1.0.9, charge les couches 1.1 historiques puis
   applique en dernier le chargeur catalogue canonique et la suppression du reset. */
(function v111Boot(){
 let tries=0;
 ...
 const load=()=>{
  ...
  add('v111fix.js',()=>add('v111catalogfix.js',()=>add('v111condition.js',()=>add('v111conditionfix.js',()=>add('v111perf.js',()=>add('v112fix.js'))))));
 };

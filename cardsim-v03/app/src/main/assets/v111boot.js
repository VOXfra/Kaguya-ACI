...
/* V1.1.7 : charge les couches historiques, le catalogue canonique, les produits
   physiques, le moteur de collation 1.1.6 puis les couches d'intégrité 1.1.7.
   Le catalogue d'énergies embarqué précède son correctif runtime. */
(function v111Boot(){
 let tries=0;
 ...
 const load=()=>{
  ...
  add('v111fix.js',()=>add('v111catalogfix.js',()=>add('v111condition.js',()=>add('v111conditionfix.js',()=>add('v111perf.js',()=>add('v112fix.js',()=>add('v113fix.js',()=>add('v114fix.js',()=>add('v115fix.js',()=>add('v116_collation_profiles.js',()=>add('v116fix.js',()=>add('v116hotfix.js',()=>add('v117_energy_catalog.js',()=>add('v117fix.js',()=>add('v117energyfix.js',()=>add('v117finalfix.js')))))))))))))))));
 };

...
(function v111Boot(){
 ...
 const load=()=>{
  ...
  add('v111fix.js',()=>add('v111catalogfix.js',()=>add('v111condition.js',()=>add('v111conditionfix.js',()=>add('v111perf.js',()=>add('v112fix.js',()=>add('v113fix.js',()=>add('v114fix.js',()=>add('v115fix.js',()=>add('v116_collation_profiles.js',()=>add('v116fix.js',()=>add('v116hotfix.js',()=>add('v117_energy_catalog.js',()=>add('v117fix.js',()=>add('v117energyfix.js',()=>add('v117finalfix.js',()=>add('v120fix.js'))))))))))))))))));
 };

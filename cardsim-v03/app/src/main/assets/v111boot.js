...
/* V1.1.6 : attend les hotfixes 1.0.9, charge les couches 1.1 historiques puis
   ...
   v116fix.js ; le hotfix final ne modifie que le cas Célébrations, qui autorise
   des doublons contrairement aux boosters classiques. */
(function v111Boot(){
 let tries=0;
 ...
 const load=()=>{
  ...
  add('v111fix.js',()=>add('v111catalogfix.js',()=>add('v111condition.js',()=>add('v111conditionfix.js',()=>add('v111perf.js',()=>add('v112fix.js',()=>add('v113fix.js',()=>add('v114fix.js',()=>add('v115fix.js',()=>add('v116_collation_profiles.js',()=>add('v116fix.js',()=>add('v116hotfix.js'))))))))))));
 };
